...
//	                    }
//	                });
//	            Reader inStream = new InputStreamReader(new FileInputStream(cf), "UTF-8");
	            properties.load(new InputStreamReader(new FileInputStream(cf), "UTF-8"));
